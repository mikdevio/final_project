...
router.get('/all', async (req, res) => {
    ...
    res.render('partials/table.ejs', { data: categoriesList, table_title: "Categories", model: "category" });
});
...
router.get('/edit/:id', async (req, res) => {
    ...
    // console.log(fields);
    res.render('partials/edit.form.ejs', { data: fields, model_name: "category" });
});

router.get('/new', (req, res) => {
    let fields = dataEmptyFromModel(Category);
    res.render('partials/new.form.ejs', { data: fields, model_name: "category" });
});
